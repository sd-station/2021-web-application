...
export class csCalendarDay extends HTMLElement {
    ...
    async Display_Data() {
        ...
        var datestring = this.getAttribute("data-date");
    ...
    UpdateDisplay() {
        if (this.date.IsToday)
            ...
            this.classList.remove("date-today");
    ...
    constructor() {
        ...
        this.addEventListener("click", event => {
            ...
            document.querySelector("calendar-box").dispatchEvent(akr);
        });
    }
}
