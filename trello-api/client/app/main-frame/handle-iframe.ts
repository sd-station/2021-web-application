...
export class HandleIframe {
    async Initialize() {
        ...
        var contentframe = document.querySelector("iframe#main-frame") as HTMLIFrameElement;
        if (!contentframe) {
             setTimeout(() => {
                this.Initialize(); 
            }, 1000);
        ...
        var navtext = document.querySelector("#txt-command") as HTMLInputElement;
        ...
        } else contentframe.src = "/app/start/index.html"
