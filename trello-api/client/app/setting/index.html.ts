...
const useroffline = document.querySelector("#setting-use-offline-data") as HTMLInputElement;
...
const rememberlastpage = document.querySelector("#setting-remember-last-page") as HTMLInputElement;
