import { DataSelectionItemClass } from "../main-window/lib/data-selection-class.js";
...
export class SideBarContainer {
    ...
    AddLink(ix: number, title: string, link: string) {
        ...
        if (this.titles.find(j => j.link == itm.link)) return false;
    ...
    async OptionsOfUserSelections() {
        ...
        Object.keys(User.trello)
            .forEach(async key => {
                var sk = User.trello[key] as DataSelectionItemClass;
                if (sk.selected) {
