...
export class csTrelloChecklist extends HTMLElement {
    ...
    Display_CheckItems() {
        ...
        this.item.checkItems.forEach(chk => {
            var el = document.createElement("trello-checkitem");
            el.dir = "auto";
            ...
            el.addEventListener("on-request", async (ev) => {
                ...
                if (ctr.startsWith("duplicate/")) {
                    ...
                    var x = await new CheckItemApi().Duplicate(this.item.idCard, itx.idChecklist, itx.id, name);
...
//# sourceMappingURL=trello-checklist.js.map