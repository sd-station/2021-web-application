...
export class csReactionItem extends HTMLElement {
    ...
    collection !: import("reaction-api").ITrelloReaction[];
    hasOwener!: boolean;
    ...
    Display_Data(): any {
        ...
        if (this.hasOwener && !this.HasProprty()) addition += 1;
        if (!this.hasOwener && this.HasProprty()) addition -= 1;
        ...
        if (this.hasOwener) this.classList.add("me"); else this.classList.remove("me");
