...
} else form.txtListName.Element.removeAttribute("readonly")
...
form.btnSubmit.addEventListener("click", async _ => {
    ...
    if (User.trello.list.selected) clist = User.trello.list.id;
